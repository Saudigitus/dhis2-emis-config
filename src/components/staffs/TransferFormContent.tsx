...
export default function TransferFormContent({
    ...
    return (
        <>
            {data !== undefined &&
                data !== null &&
                getDataStoreElement({ dataStores: data.dataStoreValues, elementKey: 'transfer', key: 'staff' })
                    ?.programStage !== null &&
                getDataStoreElement({ dataStores: data.dataStoreValues, elementKey: 'transfer', key: 'staff' })
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <GroupForm
                                                ...
                                                fields={getFormFields({
                                                    ...
                                                    programStages:
                                                        programStages !== undefined && programStages !== null
                                                            ? programStages
                                                            : [],
                                                    getDataElements,
                                                    dataElements:
                                                        dataElements !== undefined && dataElements !== null
                                                            ? dataElements
                                                            : []
                                                })}
                                            />
                                            <div className={style.btnContainer}>
                                                ...
                                                <div className={style.btnCancel}>
                                                    <Button onClick={handleCancel} disabled type="button">
                                                        Cancel
                                                    </Button>
                                                </div>
                                            </div>
