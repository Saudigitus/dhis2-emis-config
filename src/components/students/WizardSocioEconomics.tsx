...
import { type UseFetchEnrollmentDatasResponse } from '../../types/students'
...
export default function WizardSocioEconomics({ setWizardSetp }: WizardPageProps) {
