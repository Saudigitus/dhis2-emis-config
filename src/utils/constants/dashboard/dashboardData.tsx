...
const studentCards = (i18n: D2I18n) => [
    ...
    { key: "profile", hasNavigation: true, route: "profile", label: i18n.t("Student Profile"), icon: studentProfileImage, path: "profile", configurable: true },
];
...
const staffCards = (i18n: D2I18n) => [
    ...
    { key: "profile", hasNavigation: true, route: "profile", label: i18n.t("Staff Profile"), icon: workerImage, path: "profile", configurable: true },
];
