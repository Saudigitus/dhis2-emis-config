...
type formStudentFinalResultFormType = {
    ...
    programIndicatorFields: GroupFormProps["fields"],
    i18n: D2I18n
}

function formStudentProfile({ programFields, i18n, profileFields, programIndicatorFields }: formStudentFinalResultFormType) {
    return [
        {
            visible: true,
            description: "",
