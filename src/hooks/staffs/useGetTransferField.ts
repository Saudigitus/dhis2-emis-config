...
export default function useGetTransferField() {
    ...
    const getFormFields = ({ dataStoreConfigs, programStages, dataElements, getDataElements }: FormFieldProps) => {
        ...
        const foundProgramStage = getDataStoreElement({ dataStores: dataStoreConfigs, key: "staff", elementKey: "transfer" })?.programStage
        const foundDestinySchool = getDataStoreElement({ dataStores: dataStoreConfigs, key: "staff", elementKey: "transfer" })?.destinySchool
        ...
        console.log("foundProgramStage: ", foundProgramStage)
